...
//	  goto recon;
//
//  if (hdr.info.FrameWidth != w)
//	  return;
//  if (hdr.info.FrameHeight != h)
//	  return;
//
//  frame_sz = hdr.info.FrameHeight * hdr.info.InputPitch;
//  
//
//  read = fread(dest,1,frame_sz,fin);
//  //read = fread(dest,1,frame_sz/2,fin);
//  if (read < frame_sz)
//	  goto recon;
//  return;
//recon:
